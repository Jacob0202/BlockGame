...
# player variables
player_size = 50
player_pos = [int(WIDTH / 2 - (WIDTH / 2) % 50), int(HEIGHT - 2 * player_size)]
score = 0
...
while not game_over:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            # if x == 0 or x == WIDTH - player_size:  # test error checking
            #     continue
            # elif y == 0 or y == HEIGHT - player_size:
            #     continue
            #
            # else:
    ...
    # and that if it was 0 the text would be vertical, which is not correct
